...
Receive sensor data and return prediction

/export

GET

Retrieve evaluated predictions
...
Let me know if you'd like a matching `Dockerfile`, `docker-compose.yml`, or GitHub Actions workflow to go with this. I can also generate a visual architecture diagram if you're preparing a presentation or pitch.